...
|-----|-|---------|
|Video|3|https://www.youtube.com/watch?v=ijOOYHe2Ywc|
|workload is spread over the whole team (so one team member is often Xtimes more productive than the others...but nevertheless, here is a track record that everyone is contributing a lot)|3|Work has been divided equally among all team members.Everyone has almost same number of commits.https://github.com/SE-vrs-organization/slash-ui/graphs/contributors|
|Number of commits  |3|https://github.com/SE-vrs-organization/slash-ui/graphs/commit-activity|
|Number of commits: by different people  |3|The number of commits are almost equal across all team members. https://github.com/SE-vrs-organization/slash-ui/graphs/contributors|
|Issues reports: there are many  |3| https://github.com/SE-vrs-organization/slash-ui/issues|
|issues are being closed |3|An open issue is closed only after verified by one of the members.|
|DOI badge: exists|3|Evidence in readME.https://github.com/SE-vrs-organization/slash-ui/blob/main/README.md|
|Docs: doco generated , format not ugly  |3|Evidence in ReadME.https://github.com/SE-vrs-organization/slash-ui/blob/main/README.md|
|Docs: what: point descriptions of each class/function (in isolation)  |3|Description for functions given in the ReadME.https://github.com/SE-vrs-organization/slash-ui#golf-phase-5-developments|
|Docs: how: for common use cases X,Y,Z mini-tutorials showing worked examples on how to do X,Y,Z|3|Evidence in ReadME.md.| 
|Docs: why: docs tell a story, motivate the whole thing, deliver a punchline that makes you want to rush out and use the thing |3|Evidence in ReadME. https://github.com/SE-vrs-organization/slash-ui/blob/main/README.md|
|Docs: short video, animated, hosted on your repo. That convinces people why they want to work on your code. |3|Evidence in ReadME.https://github.com/SE-vrs-organization/slash-ui/blob/main/README.md|
|Use of version control tools|3|https://github.com/SE-vrs-organization/slash-ui#computer-technology-used|
|Use of style checkers |3| Yes, We have used Style checker. https://github.com/SE-vrs-organization/slash-ui/actions/workflows/style_checker.yml|
|Use of code formatters. |3|We used Prettier library to format the code in the project.|
|Use of syntax checkers. |3| Yes, We have used Syntax checker Lint.https://github.com/SE-vrs-organization/slash-ui/actions/workflows/main.yml|
|Use of code coverage  |3| https://github.com/SE-vrs-organization/slash-ui/actions/workflows/code_cov.yml|
|other automated analysis tools  |3| Yes, Used automated tool Pylint. https://github.com/SE-vrs-organization/slash-ui/actions/workflows/pylint.yml|
|test cases exist  |3| Yes, Test cases exist.https://github.com/SE-vrs-organization/slash-ui/actions/workflows/unit_test.yml|
...
|the files CONTRIBUTING.md lists coding standards and lots of tips on how to extend the system without screwing things up  |3|Evidence in Contrbuting.md.https://github.com/SE-vrs-organization/slash-ui/blob/main/CONTRIBUTING.md|
...
|Is the name of your project/software unique?|3|Slash is a unique name and even the logo is unique.|
|Is your project/software name free from trademark violations?|3|Slash is free from trademark violations.|
...
|Does your website or documentation include a project roadmap (a list of project and development milestones for the next 3, 6 and 12 months)?|Yes|https://github.com/SE-vrs-organization/slash-ui/blob/main/README.md|
